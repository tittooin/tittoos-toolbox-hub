...
<body>
    ...
    return (
        <ToolTemplate
            ...
            icon={FileText}
            features={[
                "Generate full-length SEO blog posts",
                "Customizable tone and word count",
                "Auto-generated keywords and meta descriptions",
                    ...
                    <CardContent>
                        {!generatedBlog ? (
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="prose prose-lg max-w-none border rounded-lg p-6 max-h-[600px] overflow-y-auto">
                                    <h1>{generatedBlog.title}</h1>
...
export default AIBlogGeneratorPage;
