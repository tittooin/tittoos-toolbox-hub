...
const OCRConverter = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Free OCR Converter Online – Extract Text from Images</title>
        <meta name="description" content="Convert images and PDFs to editable text with our free online OCR tool. Supports multiple languages and formats like TXT, DOCX, and PDF. Privacy-focused client-side processing." />
