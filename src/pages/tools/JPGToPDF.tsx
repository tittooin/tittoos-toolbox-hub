...
const JPGToPDF = () => {
    ...
    useEffect(() => {
        // Set SEO meta tags
        document.title = "Free JPG to PDF Converter Online - Combine Images to PDF | TittoosTools";
        const metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute('content', 'Convert JPG images to PDF online for free. Combine multiple photos into a single PDF document. No signup, secure client-side processing.');
        }
    }, []);
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            for (let i = 0; i < selectedFiles.length; i++) {
                ...
                // Calculate aspect ratio to fit A4 page (210x297mm)
                const pageWidth = 210;
                ...
                if (i > 0) doc.addPage();
                doc.addImage(imageUrl, "JPEG", x, y, renderWidth, renderHeight);

                setProgress(10 + Math.round(((i + 1) / selectedFiles.length) * 80));
            }
    ...
    return (
        <>
            <Helmet>
                <title>Free JPG to PDF Converter Online - Combine Images to PDF | TittoosTools</title>
                <meta name="description" content="Convert JPG images to PDF online for free. Combine multiple photos into a single PDF document. No signup, secure client-side processing." />
                <meta name="keywords" content="jpg to pdf, image to pdf, convert photos to pdf, combine jpg to pdf, online pdf creator, free image converter" />
            </Helmet>
            <ToolTemplate
                title="JPG to PDF Converter"
                description="Combine your images into a single, professional PDF document in seconds."
                icon={ImageIcon}
                features={features}
            >
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-lg">Images Selected</h3>
                                            <p className="text-sm text-muted-foreground">
                                                Drag to reorder or click arrows
                                            </p>
                                        </div>
                                    </div>
                                    <Button
