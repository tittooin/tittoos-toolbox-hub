      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav id="primary-navigation" className="hidden md:flex items-center space-x-8">
            ...
            <a href="/axevora-tools.apk" download className="bg-primary text-primary-foreground px-4 py-2 rounded-lg font-bold hover:bg-primary/90 transition-colors shadow-lg hover:shadow-xl active:scale-95 transform animate-pulse">
              Download App
            </a>
          </nav>
