...
export const allTools = [
  ...
  },
  {
    id: "snake-game",
    name: "Snake",
    subheading: "Classic Arcade Game",
    description: "Navigate the grid, collect food to grow your snake, and avoid collisions with boundaries and your own tail.",
    keywords: ["snake", "retro", "arcade", "classic", "grow", "game"],
    category: "games",
    icon: Gamepad2,
    path: "/tools/snake",
  },
  {
    id: "sky-hopper",
    name: "Sky Hopper",
    subheading: "Arcade Aerial Tapper",
    description: "Flap your wings and navigate through floating obstacles in this addictive retro arcade game.",
    keywords: ["sky hopper", "flappy", "hopper", "tap", "fly", "arcade", "game"],
    category: "games",
    icon: Rocket,
    path: "/tools/sky-hopper",
  },
  {
    id: "minesweeper",
    name: "Minesweeper",
    subheading: "Classic Grid Logic",
    description: "Clear the minefield using logic clues without detonating any hidden mines. Flag suspected cells to win!",
    keywords: ["minesweeper", "mines", "puzzle", "logic", "grid", "flag", "game"],
    category: "games",
    icon: Bomb,
  ...
  },
  {
    id: "sudoku",
    name: "Sudoku",
    subheading: "9x9 Number Puzzle",
    description: "Fill the 9x9 grid so every row, column, and 3x3 box contains digits 1 to 9 without repeating.",
    keywords: ["sudoku", "number", "puzzle", "logic", "grid", "math", "game"],
    category: "games",
    icon: Hash,
    path: "/tools/sudoku",
  },
  {
    id: "whack-a-mole",
    name: "Whack-a-Mole",
    subheading: "Fast-Paced Reflex Game",
    description: "Test your quick reactions by whacking emerging critters before they vanish back underground!",
    keywords: ["whack", "mole", "reaction", "reflex", "speed", "tap", "game"],
    category: "games",
    icon: Target,
  ...
  {
    id: "color-reaction",
    name: "Color Reaction Challenge",
    subheading: "Visual Reflex Battle",
    description: "React instantly when the target color matches the cue. Beat your high score and speed benchmark!",
    keywords: ["color", "reaction", "reflex", "speed", "challenge", "game"],
    category: "games",
    icon: Zap,
  ...
  },
  {
    id: "simon-memory",
    name: "Simon Memory",
    subheading: "Classic Color Sequence",
    description: "Watch and memorize the sequence of flashing colors and tones, then repeat it back in exact order.",
    keywords: ["simon", "memory", "sequence", "color", "brain", "pattern", "game"],
    category: "games",
    icon: Sparkles,
    path: "/tools/simon-memory",
  },
  {
    id: "sequence-memory",
    name: "Sequence Memory",
    subheading: "Visual Spatial Memory",
    description: "Memorize the sequence of highlighted tiles across a 3x3 grid and recreate the pattern accurately.",
    keywords: ["sequence", "memory", "grid", "visual", "brain", "pattern", "game"],
    category: "games",
    icon: Layers,
  ...
  },
  {
    id: "chess-game",
    name: "Chess Online",
    subheading: "Classic 8x8 Strategy Board Game",
    description: "Play Chess online for free against computer AI or challenge a friend in 2-player mode. Features authentic move validation, check detection, and captured piece counters.",
    keywords: ["chess", "chess online", "play chess", "free chess", "chess board game", "strategy game", "board game"],
    category: "games",
    icon: Crown,
    path: "/tools/chess",
  },
  {
    id: "8-ball-pool",
    name: "8 Ball Pool",
    subheading: "Realistic 2D Billiards Simulator",
    description: "Play free 8 Ball Pool online with authentic physics, cue ball aiming guide, power meter, ball collisions, and standard solids vs stripes pocketing rules.",
    keywords: ["8 ball pool", "pool game", "billiards", "play pool online", "cue sports", "free 8 ball pool", "board game"],
    category: "games",
    icon: CircleDot,
    path: "/tools/8-ball-pool",
  },
  {
    id: "ludo-game",
    name: "Ludo Classic",
    subheading: "Traditional 4-Player Board Game",
    description: "Roll the dice and race your 4 tokens home in this classic Ludo board game. Play against computer AI or pass & play with friends with authentic safe zones and capture mechanics.",
    keywords: ["ludo", "ludo online", "play ludo", "ludo board game", "free ludo", "pachisi", "board game"],
    category: "games",
    icon: Dices,
    path: "/tools/ludo",
  },
  {
    ...
    subheading: "Klondike Solitaire Card Game",
    description: "Play classic Klondike Solitaire card game online for free. Features standard 52-card deck, 7 tableau columns, 4 suit foundations Ace through King, and smooth tap-to-move controls.",
    keywords: ["solitaire", "solitaire online", "free solitaire", "klondike solitaire", "patience card game", "classic solitaire"],
    category: "games",
    icon: Layers,
  ...
  },
  {
    ...
    subheading: "4-Player Partnership Trick Taking",
    description: "Play Spades card game online against smart AI bots. Form partnerships, bid your tricks accurately, follow suit, trump with Spades, and avoid penalty sandbags.",
    keywords: ["spades", "spades online", "play spades", "spades card game", "trick taking card game", "free spades"],
    category: "games",
    icon: Spade,
    path: "/tools/spades",
  },
  {
    ...
    subheading: "English Draughts 8x8 Board Game",
    description: "Play classic American Checkers (English Draughts) online. Jump over opponent pieces, promote your draughts to crowned Kings, and capture the entire board.",
    keywords: ["checkers", "checkers online", "play checkers", "draughts", "free checkers game", "board game"],
    category: "games",
    icon: Grid3X3,
    path: "/tools/checkers",
  },
